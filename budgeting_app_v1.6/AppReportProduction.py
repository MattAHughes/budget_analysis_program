...
class ReportGeneration:
    ...
    def create_report(self):
        ...
        self.yearly_total_pre_tax = round(((self.yearly_total_post_tax + 5092 - (45000 * 0.325))/0.675) * 1.02, 2)
        ...
        html = template.render(page_title_text='Budget Overview',
                               ...
                               text_string_3 ='Making for an approximate yearly pre-tax total (excluding HELP) of:',
